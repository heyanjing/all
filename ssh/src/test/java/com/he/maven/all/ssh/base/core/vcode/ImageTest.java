...
/**
 * Created by heyanjing on 2018/1/15 16:13.
 */
...
public class ImageTest {
    ...
    public static void main(String[] args) throws IOException {
        String filename = "C:\\temp\\rgb\\1.png";// separator是File里的一个常量,由于java历史遗留问题故为小写
        ...
        ImageIO.write(bufferedImage, "png", new File("C:\\temp\\rgb\\1new.png"));
    }
 ...
 @Test
     public void t() {
     System.out.println(Integer.parseInt("b0",16));
     }
